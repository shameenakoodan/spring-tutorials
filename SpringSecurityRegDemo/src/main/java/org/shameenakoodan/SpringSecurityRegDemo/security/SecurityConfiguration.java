...
import org.shameenakoodan.SpringSecurityRegDemo.service.UserServiceImpl;
...
public class SecurityConfiguration {
	   ...
	   public DaoAuthenticationProvider authenticationProvider() {
	       ...
	       auth.setUserDetailsService((UserDetailsService) userDetailsService); //set the custom user details service
